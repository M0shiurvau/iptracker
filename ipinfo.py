...
def ipinfo():
       ...
       print (" ")
       slowprint("\033[1;36m =====================================")
       slowprint("\033[1;33m|        MADE  By MOSHIURVAU           |")
       slowprint("\033[1;36m =====================================")
       slowprint("\033[1;91m|      FOLLOW US ON FACEBOOK           |")
       slowprint("\033[1;36m =====================================")
       print (" ")
...
def about():
       ...
       time.sleep(2)
       slowprint ("\033[1;91m -----------------------------------------------")
       slowprint ("\033[1;33m" + "         [+] Tool Name     =>\033[1;36m" + " IP-Tracker")
       slowprint ("\033[1;33m" + "         [+] Autor         =>\033[1;36m" + " MOSHIUTVAU")
       slowprint ("\033[1;33m" + "         [+] Latest Update =>\033[1;36m" + " 19/8/2020")
       slowprint ("\033[1;33m" + "         [+] YouTube       =>\033[1;36m" + " MOSHIUR VAU")
       slowprint ("\033[1;33m" + "         [+] Github        =>\033[1;36m" + " M0shiurvau ")
       slowprint ("\033[1;91m -----------------------------------------------")
       slowprint ("\033[1;95m" + "          [+] FOLLOW US ON TWITTER [+]          ")
       slowprint ("\033[1;91m -----------------------------------------------")
...
def ext():
      slowprint ("\033[1;36m ==============================================")
      slowprint ("\033[1;33m|      Thanks For Using IP-TRACKER            |")
      slowprint ("\033[1;36m ==============================================")
      time.sleep(1)
      exit()
